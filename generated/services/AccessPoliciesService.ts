...
export class AccessPoliciesService {
     ...
     * @throws ApiError
     */
    public accessPoliciesDeleteAnAccessPolicy({
        uuid,
        uuid1,
        identifier,
        requestBody,
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/accounts/{identifier}/access/apps/{uuid1}/policies/{uuid}',
            path: {
                'uuid': uuid,
                'uuid1': uuid1,
     ...
     * @throws ApiError
     */
    public accessPoliciesGetAnAccessPolicy({
        uuid,
        uuid1,
        identifier,
    }: {
     ...
     * @throws ApiError
     */
    public accessPoliciesUpdateAnAccessPolicy({
        uuid,
        uuid1,
        identifier,
        requestBody,
     ...
     * @throws ApiError
     */
    public accessPoliciesListAccessPolicies({
        uuid,
        identifier,
    }: {
        uuid: components_schemas_uuid,
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounts/{identifier}/access/apps/{uuid}/policies',
            path: {
                'uuid': uuid,
                'identifier': identifier,
            },
     ...
     * @throws ApiError
     */
    public accessPoliciesCreateAnAccessPolicy({
        uuid,
        identifier,
        requestBody,
    }: {
