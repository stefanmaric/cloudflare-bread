...
export class ZoneLevelAccessMTlsAuthenticationService {
     ...
     * @throws ApiError
     */
    public zoneLevelAccessMTlsAuthenticationListMTlsCertificates({
        identifier,
    }: {
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/zones/{identifier}/access/certificates',
            path: {
     ...
     * @throws ApiError
     */
    public zoneLevelAccessMTlsAuthenticationAddAnMTlsCertificate({
        identifier,
        requestBody,
    }: {
        identifier: common_components_schemas_identifier,
     ...
     * @throws ApiError
     */
    public zoneLevelAccessMTlsAuthenticationDeleteAnMTlsCertificate({
        uuid,
        identifier,
        requestBody,
    }: {
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/zones/{identifier}/access/certificates/{uuid}',
            path: {
                'uuid': uuid,
                'identifier': identifier,
            },
     ...
     * @throws ApiError
     */
    public zoneLevelAccessMTlsAuthenticationGetAnMTlsCertificate({
        uuid,
        identifier,
    }: {
        uuid: uuid,
     ...
     * @throws ApiError
     */
    public zoneLevelAccessMTlsAuthenticationUpdateAnMTlsCertificate({
        uuid,
        identifier,
        requestBody,
    }: {
