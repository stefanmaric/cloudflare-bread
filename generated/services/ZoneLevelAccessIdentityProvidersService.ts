...
export class ZoneLevelAccessIdentityProvidersService {
     ...
     * @throws ApiError
     */
    public zoneLevelAccessIdentityProvidersListAccessIdentityProviders({
        identifier,
    }: {
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/zones/{identifier}/access/identity_providers',
            path: {
     ...
     * @throws ApiError
     */
    public zoneLevelAccessIdentityProvidersAddAnAccessIdentityProvider({
        identifier,
        requestBody,
    }: {
        identifier: identity_providers_components_schemas_identifier,
     ...
     * @throws ApiError
     */
    public zoneLevelAccessIdentityProvidersDeleteAnAccessIdentityProvider({
        uuid,
        identifier,
        requestBody,
    }: {
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/zones/{identifier}/access/identity_providers/{uuid}',
            path: {
                'uuid': uuid,
                'identifier': identifier,
            },
     ...
     * @throws ApiError
     */
    public zoneLevelAccessIdentityProvidersGetAnAccessIdentityProvider({
        uuid,
        identifier,
    }: {
        uuid: uuid,
     ...
     * @throws ApiError
     */
    public zoneLevelAccessIdentityProvidersUpdateAnAccessIdentityProvider({
        uuid,
        identifier,
        requestBody,
    }: {
