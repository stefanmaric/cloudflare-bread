...
export class AccessShortLivedCertificateCAsService {
     ...
     * @throws ApiError
     */
    public accessShortLivedCertificateCAsListShortLivedCertificateCAs({
        identifier,
    }: {
        ...
        return this.httpRequest.request({
            method: 'GET',
            url: '/accounts/{identifier}/access/apps/ca',
            path: {
     ...
     * @throws ApiError
     */
    public accessShortLivedCertificateCAsDeleteAShortLivedCertificateCa({
        uuid,
        identifier,
        requestBody,
    }: {
        ...
        return this.httpRequest.request({
            method: 'DELETE',
            url: '/accounts/{identifier}/access/apps/{uuid}/ca',
            path: {
                'uuid': uuid,
                'identifier': identifier,
            },
     ...
     * @throws ApiError
     */
    public accessShortLivedCertificateCAsGetAShortLivedCertificateCa({
        uuid,
        identifier,
    }: {
        uuid: uuid,
     ...
     * @throws ApiError
     */
    public accessShortLivedCertificateCAsCreateAShortLivedCertificateCa({
        uuid,
        identifier,
        requestBody,
    }: {
